...
save_path = "conversion_"+str(size)+".png"
...
plots.plot_conversion(conversion_series, title="Conversión vs Tiempo - modelo isotrópico 3D",
                      save_path=save_path) # Cambiar a argv

# Que se grafiquen superpuestas para mejorar comparación

#save_file = "conversion_"+str(size)+".png"

# Crear ficheros de outputs